...
ic_table <- data.frame(
  ...
  `Component` = c(
    "\\includegraphics[width=0.18\\linewidth]{data_OSF/outputs/parcellations_plots/GICA15/GICA15_IC1_cropped.png}",
    "\\includegraphics[width=0.18\\linewidth]{data_OSF/outputs/parcellations_plots/GICA15/GICA15_IC15_cropped.png}"
  ),
  
  `Mean` = c(
    "\\includegraphics[width=0.18\\linewidth]{data_OSF/outputs/priors_plots/GICA15/combined/GSR/prior_combined_GICA15_GSR_IC1_mean_cropped.png}",
    "\\includegraphics[width=0.18\\linewidth]{data_OSF/outputs/priors_plots/GICA15/combined/GSR/prior_combined_GICA15_GSR_IC15_mean_cropped.png}"
  ),
  
  `Sqrt Var` = c(
    "\\includegraphics[width=0.18\\linewidth]{data_OSF/outputs/priors_plots/GICA15/combined/GSR/prior_combined_GICA15_GSR_IC1_sd_cropped.png}",
    "\\includegraphics[width=0.18\\linewidth]{data_OSF/outputs/priors_plots/GICA15/combined/GSR/prior_combined_GICA15_GSR_IC15_sd_cropped.png}"
  )
)

kable(ic_table, escape = FALSE, align = c("c", "c", "c", "c"),
      col.names = c("IC", "Component", "Mean", "Standard Deviation")) %>%
...
ic_table <- data.frame(
  ...
  `Component` = c(
    "\\includegraphics[width=0.18\\linewidth]{data_OSF/outputs/parcellations_plots/GICA25/GICA25_IC1_cropped.png}",
    "\\includegraphics[width=0.18\\linewidth]{data_OSF/outputs/parcellations_plots/GICA25/GICA25_IC25_cropped.png}"
  ),
  
  `Mean` = c(
    "\\includegraphics[width=0.18\\linewidth]{data_OSF/outputs/priors_plots/GICA25/combined/GSR/prior_combined_GICA25_GSR_IC1_mean_cropped.png}",
    "\\includegraphics[width=0.18\\linewidth]{data_OSF/outputs/priors_plots/GICA25/combined/GSR/prior_combined_GICA25_GSR_IC25_mean_cropped.png}"
  ),
  
  `Sqrt Var` = c(
    "\\includegraphics[width=0.18\\linewidth]{data_OSF/outputs/priors_plots/GICA25/combined/GSR/prior_combined_GICA25_GSR_IC1_sd_cropped.png}",
    "\\includegraphics[width=0.18\\linewidth]{data_OSF/outputs/priors_plots/GICA25/combined/GSR/prior_combined_GICA25_GSR_IC25_sd_cropped.png}"
  )
)
...
ic_table <- data.frame(
  ...
  `Component` = c(
    "\\includegraphics[width=0.18\\linewidth]{data_OSF/outputs/parcellations_plots/GICA50/GICA50_IC1_cropped.png}",
    "\\includegraphics[width=0.18\\linewidth]{data_OSF/outputs/parcellations_plots/GICA50/GICA50_IC50_cropped.png}"
  ),
  
  `Mean` = c(
    "\\includegraphics[width=0.18\\linewidth]{data_OSF/outputs/priors_plots/GICA50/combined/GSR/prior_combined_GICA50_GSR_IC1_mean_cropped.png}",
    "\\includegraphics[width=0.18\\linewidth]{data_OSF/outputs/priors_plots/GICA50/combined/GSR/prior_combined_GICA50_GSR_IC50_mean_cropped.png}"
  ),
  
  `Sqrt Var` = c(
    "\\includegraphics[width=0.18\\linewidth]{data_OSF/outputs/priors_plots/GICA50/combined/GSR/prior_combined_GICA50_GSR_IC1_sd_cropped.png}",
    "\\includegraphics[width=0.18\\linewidth]{data_OSF/outputs/priors_plots/GICA50/combined/GSR/prior_combined_GICA50_GSR_IC50_sd_cropped.png}"
  )
)
...
```{r fig.show='hold', out.width='48%', echo=FALSE}
ic_table <- data.frame(
  `Network` = c("DefaultA", "DorsAttnA"),
  
  `Component` = c(
    "\\includegraphics[width=0.18\\linewidth]{data_OSF/outputs/parcellations_plots/Yeo17/Yeo17_DefaultA_cropped.png}",
    "\\includegraphics[width=0.18\\linewidth]{data_OSF/outputs/parcellations_plots/Yeo17/Yeo17_DorsAttnA_cropped.png}"
  ),
  
  `Mean` = c(
    "\\includegraphics[width=0.18\\linewidth]{data_OSF/outputs/priors_plots/Yeo17/combined/GSR/prior_combined_Yeo17_GSR_DefaultA_mean_cropped.png}",
    "\\includegraphics[width=0.18\\linewidth]{data_OSF/outputs/priors_plots/Yeo17/combined/GSR/prior_combined_Yeo17_GSR_DorsAttnA_mean_cropped.png}"
  ),
  
  `Sqrt Var` = c(
    "\\includegraphics[width=0.18\\linewidth]{data_OSF/outputs/priors_plots/Yeo17/combined/GSR/prior_combined_Yeo17_GSR_DefaultA_sd_cropped.png}",
    "\\includegraphics[width=0.18\\linewidth]{data_OSF/outputs/priors_plots/Yeo17/combined/GSR/prior_combined_Yeo17_GSR_DorsAttnA_sd_cropped.png}"
  )
)
