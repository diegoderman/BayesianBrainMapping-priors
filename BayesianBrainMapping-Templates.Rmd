...
- A prior based on 15 independent components (GICA15) estimated from the HCP dataset with global signal regression (GSR) and the `combined` list of subjects.
...
prior <- readRDS("priors/GICA15/prior_combined_GICA15_GSR.rds")
...
For all outputs, we only visualize independent component (IC) 1.

```{r, eval=FALSE, echo=FALSE}
plot(bMap, idx = 1:15, stat = "mean", title = paste("Subject-Level Mean - IC", 1:15),
     fname_suffix="idx", fname=file.path(dir_data, "outputs", "subject_maps", "posterior"))
```

```{r, echo=FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics(file.path(dir_data, "outputs", "subject_maps", "posterior_mean_1.png"))
```

```{r, eval=FALSE, echo=FALSE}
plot(bMap, idx = 1:15, stat = "se", title = paste("Subject-Level SE - IC", 1:15),
     fname_suffix="idx", fname=file.path(dir_data, "outputs", "subject_maps", "posterior"))
```

```{r, echo=FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics(file.path(dir_data, "outputs", "subject_maps", "posterior_se_1.png"))
```

```{r, eval=FALSE, echo=FALSE}
plot(eng, idx = 1:15, stat="engaged", title = paste("Engagement Map - IC", 1:15),
     fname_suffix="idx", fname=file.path(dir_data, "outputs", "subject_maps", "subject"))
```

```{r, echo=FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics(file.path(dir_data, "outputs", "subject_maps", "subject_engaged_1.png"))
knitr::include_graphics(file.path(dir_data, "outputs", "subject_maps", "subject_engaged_1_legend.png"))
```
