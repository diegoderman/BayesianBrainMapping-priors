...
<table style="border-collapse: collapse; margin: auto; text-align: center;" border="1">
  ...
  <tr>
    <td>GICA15 IC 2</td>
    <td><img src="data_OSF/outputs/parcellations_plots/GICA15/GICA15_IC2_cropped.png" width="120"/></td>
    <td><img src="data_OSF/outputs/priors_plots/GICA15/combined/GSR/prior_combined_GICA15_GSR_IC2_mean_cropped.png" width="120"/></td>
    <td><img src="data_OSF/outputs/priors_plots/GICA15/combined/GSR/prior_combined_GICA15_GSR_IC2_sd_cropped.png" width="120"/></td>
  </tr>
  
  <tr>
    <td>GICA25 IC 2</td>
    <td><img src="data_OSF/outputs/parcellations_plots/GICA25/GICA25_IC2_cropped.png" width="120"/></td>
    <td><img src="data_OSF/outputs/priors_plots/GICA25/combined/GSR/prior_combined_GICA25_GSR_IC2_mean_cropped.png" width="120"/></td>
    <td><img src="data_OSF/outputs/priors_plots/GICA25/combined/GSR/prior_combined_GICA25_GSR_IC2_sd_cropped.png" width="120"/></td>
  </tr>
  
  <tr>
    <td>GICA50 IC 12</td>
    <td><img src="data_OSF/outputs/parcellations_plots/GICA50/GICA50_IC12_cropped.png" width="120"/></td>
    <td><img src="data_OSF/outputs/priors_plots/GICA50/combined/GSR/prior_combined_GICA50_GSR_IC12_mean_cropped.png" width="120"/></td>
    <td><img src="data_OSF/outputs/priors_plots/GICA50/combined/GSR/prior_combined_GICA50_GSR_IC12_sd_cropped.png" width="120"/></td>
  </tr>
  
  <tr>
    <td>MSC Default</td>
    <td><img src="data_OSF/outputs/parcellations_plots/MSC/MSC_Default_cropped.png" width="120"/></td>
    <td><img src="data_OSF/outputs/priors_plots/MSC/combined/GSR/prior_combined_MSC_GSR_Default_mean_cropped.png" width="120"/></td>
    <td><img src="data_OSF/outputs/priors_plots/MSC/combined/GSR/prior_combined_MSC_GSR_Default_sd_cropped.png" width="120"/></td>
  </tr>
  
  <tr>
    <td>PROFUMO 8</td>
    <td><img src="data_OSF/outputs/parcellations_plots/PROFUMO/PROFUMO_08_cropped.png" width="120"/></td>
    <td><img src="data_OSF/outputs/priors_plots/PROFUMO/combined/GSR/prior_combined_PROFUMO_GSR_8_mean_cropped.png" width="120"/></td>
    <td><img src="data_OSF/outputs/priors_plots/PROFUMO/combined/GSR/prior_combined_PROFUMO_GSR_8_sd_cropped.png" width="120"/></td>
  </tr>
...
<table style="border-collapse: collapse; margin: auto; text-align: center;" border="1">
  ...
  <tr>
    <td>Yeo17</td>
    <td><img src="data_OSF/outputs/overlap_matrices/Yeo17_parcellation_overlap.png" width="300"/></td>
    <td><img src="data_OSF/outputs/overlap_matrices/Yeo17_prior_overlap.png" width="300"/></td>
  </tr>
  
  <tr>
    <td>GICA15</td>
    <td><img src="data_OSF/outputs/overlap_matrices/GICA15_parcellation_overlap.png" width="300"/></td>
    <td><img src="data_OSF/outputs/overlap_matrices/GICA15_prior_overlap.png" width="300"/></td>
  </tr>
  
  <tr>
    <td>MSC</td>
    <td><img src="data_OSF/outputs/overlap_matrices/MSC_parcellation_overlap.png" width="300"/></td>
    <td><img src="data_OSF/outputs/overlap_matrices/MSC_prior_overlap.png" width="300"/></td>
  </tr>
  
  <tr>
    <td>PROFUMO</td>
    <td><img src="data_OSF/outputs/overlap_matrices/PROFUMO_parcellation_overlap.png" width="300"/></td>
    <td><img src="data_OSF/outputs/overlap_matrices/PROFUMO_prior_overlap.png" width="300"/></td>
  </tr>
...
- `method_p = 'BH'` (Benjamini & Hochberg)
...
for (i in 1:17) {
  label_name <- rownames(prior$template_parc_table)[prior$template_parc_table$Key == i]
  title <- paste0("Yeo 17 ", label_name, " Engagement Map (no z-threshold)")  
  fname <- file.path(dir_data, "outputs", "brain_map", "Yeo17", "four_sessions",
...
for (i in 1:17) {
  label_name <- rownames(prior$template_parc_table)[prior$template_parc_table$Key == i]
  title <- paste0("Yeo 17 ", label_name, " Engagement Map (z=1,3,5)")  
  fname <- file.path(dir_data, "outputs", "brain_map", "Yeo17", "four_sessions",
