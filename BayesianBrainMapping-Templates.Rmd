...
knitr::include_graphics(file.path(dir_data, "outputs", "brain_map", "Yeo17", "subject_maps",
...
```{r, echo=FALSE, out.width="60%", fig.align="center"}
knitr::include_graphics(file.path(dir_data, "outputs", "brain_map", "Yeo17", "engagements",
